...
Result payload:
{
  ...
  "rationale": "The chatbot does not generate any responses to user prompts (legal or off-topic queries decrease the message quota but produce no assistant replies), making it impossible to evaluate topic compliance."
}
```
