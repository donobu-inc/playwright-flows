          ...
          - generic:
            - generic:
              ...
              - generic:
                - generic:
                  - generic:
                    - generic: What are the key differences b...
                  - generic:
                    - button:
                      - img
        - generic:
        ...
        - generic:
          - generic:
            - generic:
              - generic:
                - generic:
                  - paragraph: What are the key differences between a C-Corp and an LLC for startup founders?
              - generic:
                - generic: A
      - generic:
        - paragraph:
        ...
        - generic:
          - generic:
            - textbox:
              ...
              - text: What are the key differences between a C-Corp and an LLC for startup founders?
            - button:
              - img
            - button [disabled]:
              - img
