...
test(title, details, async ({ page }) => {
  ...
  // Asserting the presence of summer season vibes on the featured menu page.
  ...
  // Asserting that the address of the Starbucks store in Stowe, Vermont is correct and the map shows Mt. Mansfield nearby.
  await page.visuallyAssert({
    assertionToTestFor:
