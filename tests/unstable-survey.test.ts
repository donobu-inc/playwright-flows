...
test(title, details, async ({ page }) => {
  ...
  // Entering a randomized email to proceed with the survey.
  ...
  // Selecting the age group to proceed with the survey.
  ...
  // Selecting 'Social Media' as the response to how the user heard about the survey.
  await page.clickElement({
    selector: {
      element: [
        '#\\:r5\\:-form-item',
